...
<style scoped>
 ...
 .dropdown-menu>li>a:hover{color:#ff8a06 !important}
 .dropdown-menu>li>a:hover .nav_item{background:red !important}
.dropdown-menu>.nav_item+.nav_item{border-top:1px solid rgba(0, 0, 0, 0.15)}
</style>